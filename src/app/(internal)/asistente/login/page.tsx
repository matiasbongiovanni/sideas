...
import { asistenteLogin } from "@/lib/supabase/actions"
...
export default function AsistenteLoginPage() {
  ...
  const [state, formAction, pending] = useActionState(asistenteLogin, initialState)
    ...
    <div className="min-h-screen w-full flex bg-white">
      <div className="w-full lg:w-1/2 flex flex-col relative px-8 sm:px-16 lg:px-24 py-12">
        ...
        <div className="w-full max-w-md mx-auto my-auto">
          <div className="mb-10">
            <p className="text-xs font-bold uppercase tracking-[0.32em] text-[#4398FF] mb-3">
              Asistente Personal
            </p>
            ...
            <p className="text-sm text-slate-500 leading-relaxed">
              Acceso exclusivo y personal. Tareas, contactos, correo y calendario del agente n8n.
            </p>
          </div>
        ...
        <div className="mt-auto pt-8">
          <p className="text-xs text-slate-400">
            © {new Date().getFullYear()} SIDEAS Consultores. Acceso restringido.
          </p>
        </div>
      </div>
